...
REM Set the OSVersion (W7 or WXP)***************************************
Set OSVersion=WXP
...
del /F /Q "%DownloadSourceFromInternetDir%\downloadSL.vbs"
...
mkdir "%DownloadSourceFromInternetDir%"
del /F /Q "%DownloadSourceFromInternetDir%\downloadROK.vbs"
...
del /F /Q "%DownloadSourceFromInternetDir%\%ROKConfig%"
