...
REM *************************************************************************
REM ROK Silent deployment V1.1
...
set DeployServer=\\192.168.1.57\share\

REM Set LogLocation to a central directory to collect log files.**************
Set LogLocation=\\192.168.1.57\share\SilverlightLogs
...
set DownloadSourceFromInternet=N
...
if %UninstallROK%==Y (goto UninstallROKBeforeInstall) else (EndUninstallROKBeforeInstall)
...
robocopy %USERPROFILE%\AppData\Local\ROK %DeployServer%\WebAutoDir /E
...
robocopy %DeployServer%\WebAutoDir %USERPROFILE%\AppData\Local\ROK /E
:EndDownloadWebautoFiles
cd %ProgramFiles%\Microsoft Silverlight\
if %UninstallROK% == N then (goto SLlauncherWithoutOverWrite) else (goto SLlauncherWithOverWrite)
